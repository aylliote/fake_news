...
## usefull categorical sources

usefull_sources = ['Barack Obama', 'Bill Clinton', 'Sherrod Brown', 'Rob Portman',
                  'Tim Kaine', 'Dennis Kucinich', 'Bill Nelson', 'Chain email',
                  'Bloggers', 'Democratic Congressional Campaign Committee']
